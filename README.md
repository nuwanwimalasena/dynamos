...
![Dynamos Mockup](file:///home/nuwan/.gemini/antigravity/brain/613b1244-afed-46c3-8f96-52d03546c2cd/dynamos_mockup_1772471766516.png)
...
Dynamos is a modern, cross-platform desktop application designed to make managing AWS DynamoDB tables and data effortless. Built with performance and user experience in mind, it provides a powerful interface for developers to interact with their NoSQL data.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/nuwanwimalasena/dynamos.git
   cd dynamos
   ```
